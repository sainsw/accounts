          ...
          {inv.extraReferences.map((ref, i) => (
            <div key={ref.id} className="rounded-lg border border-slate-200 p-3 dark:border-slate-700">
              <div className="flex items-center gap-2">
                ...
                <button type="button" aria-label="Remove" onClick={() => removeRef(ref.id)}
                  className="inline-flex h-8 w-8 items-center justify-center rounded-lg text-slate-400 transition hover:bg-red-50 hover:text-red-500 dark:hover:bg-red-500/10 dark:hover:text-red-400">
