...
export type NavItem = {
  href: string;
  /** Label used in the desktop sidebar — can be more descriptive. */
  label: string;
  /** Shorter label for the mobile tab bar. Falls back to `label`. */
  short?: string;
  icon: ComponentType<IconProps>;
  /** Only show when the user is VAT registered. */
  requiresVat?: boolean;
};
...
// Primary destinations — the things a freelancer touches regularly.
...
export const secondaryNavItems: NavItem[] = [
  ...
  { href: '/vat', label: 'VAT', icon: VatIcon, requiresVat: true },
  { href: '/reports', label: 'Reports', icon: ReportsIcon },
  { href: '/settings', label: 'Settings', icon: SettingsIcon },
];

// On mobile the bottom bar shows these; everything else lives behind "More".
...
// The "+ New" menu — plain-language entry points that deep-link to each page
// and open its create form via the `?new=1` query param.
export const createActions: CreateAction[] = [
  {
    label: 'Money in or out',
    description: 'Record income you received or money you spent',
    href: '/transactions?new=1',
    icon: TransactionsIcon,
  },
  {
    label: 'Invoice',
    description: 'Create or track an invoice for a client',
    href: '/invoices?new=1',
    icon: InvoicesIcon,
  },
  {
    label: 'Client',
    description: 'Add someone you do work for',
    href: '/clients?new=1',
    icon: ClientsIcon,
  },
];
